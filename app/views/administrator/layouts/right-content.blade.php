        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p class="text-muted page-title-alt">Welcome to Booking Early admin panel !</p>
                </div>
            </div>
                    ...
                    <div class="card-box">
                        ...
                        <div class="widget-chart text-center">
                            <input class="knob" data-width="150" data-height="150" data-linecap=round
                                   data-fgColor="#fb6d9d" value="80" data-skin="tron" data-angleOffset="180"
                        ...
                        <div class="table-responsive">
                            <table class="table table-actions-bar m-b-0">
                                ...
                                <tr>
                                    ...
                                    <td><img src="images/products/iphone.jpg" class="thumb-sm pull-left m-r-10"
                                             alt=""> Apple iPhone
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="images/products/samsung.jpg" class="thumb-sm pull-left m-r-10"
                                             alt=""> Samsung Phone
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="images/products/imac.jpg" class="thumb-sm pull-left m-r-10"
                                             alt=""> Apple iPhone
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="images/products/macbook.jpg" class="thumb-sm pull-left m-r-10"
                                             alt=""> Apple iPhone
                                    </td>
                                ...
                                <tr>
                                    <td><span data-plugin="peity-bar" data-colors="#5fbeaa,#ebeff2" data-width="80"
                                              data-height="30">5,3,9,6,5,9,7,3,5,2</span></td>
                                    <td><img src="images/products/lumia.jpg" class="thumb-sm pull-left m-r-10"
                                             alt=""> Lumia iPhone
                                    </td>
                                    <td><span class="text-custom">+$230</span></td>
                                    <td>
